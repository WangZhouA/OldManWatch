 ...
 * @Describe
 */
public class CreateClockActivity extends BaseMvpAppCompatActivity<ReimndPresenter> implements ReimndView<BaseResponse> {
    ...
    protected int getLayoutId() {
        return R.layout.activity_create_clock;
    }
