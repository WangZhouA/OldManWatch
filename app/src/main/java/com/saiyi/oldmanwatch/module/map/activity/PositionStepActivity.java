 ...
 * @Describe 定位器记步页面
 */
public class PositionStepActivity extends BaseMvpAppCompatActivity<StepPresenter> implements StepView<StepBean> {
    ...
    protected int getLayoutId() {
        return R.layout.activity_position_step;
    }
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        tvBarTitle.setText(R.string.step_by_step);
        mContext = this;
    }
    ...
    protected void initData() {
        ...
        if ("1".equals(type)) {
            llTooBar.setBackgroundColor(getResources().getColor(R.color.appColor));
            dHPView.setProgressColor(getResources().getColor(R.color.appColor));
        } else {
            llTooBar.setBackgroundColor(getResources().getColor(R.color.appColor_position));
            dHPView.setProgressColor(getResources().getColor(R.color.appColor_position));
        }
    ...
    @OnClick({R.id.tv_BarLeft, R.id.ll_left, R.id.tv_time, R.id.ll_right})
    public void onViewClicked(View v) {
        QueryStepBean step = new QueryStepBean();
        step.setMac(mac);
        switch (v.getId()) {
...
//        BarData data = new BarData(dataSets);
    ...
    public void onRequestSuccessData(StepBean data) {
        ...
        showBarChart(data.getSteps(), null, "1".equals("type") ? getResources().getColor(R.color.blue) : getResources().getColor(R.color.appColor_position));
