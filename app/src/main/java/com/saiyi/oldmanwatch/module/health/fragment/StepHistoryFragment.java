 ...
 * @Describe 历史记步记录
 */
public class StepHistoryFragment extends BaseMvpFragment<StepPresenter> implements StepView<StepBean> {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_step_history;
    }
                ...
                mPickerView.setOnoptionsSelectListener(new OptionsPickerView.OnOptionsSelectListener() {
                    ...
                    public void onOptionsSelect(String t1, String t2, String t3) {
                        ...
                        if (tvTimeLeft.getText().toString().compareTo(tvTimeRight.getText().toString()) == -1) {
                            mPresenter.getStep(StepHistoryFragment.this);
                        } else {
...
//        showBarChart(data.getData().get(0).getSteps(), "", getResources().getColor(R.color.blue));
    }
