...
public class ClockActivity extends BaseMvpAppCompatActivity<RemindListPresenter> implements RemindListView<List<ReimndList>> {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_add_reminding:
                ...
                intent.setClass(mContext, CreateClockActivity.class);
    ...
    public void onRequestSuccessData(List<ReimndList> data) {
        mDatas.clear();
        if (data != null) {
            tvHintClock.setVisibility(View.INVISIBLE);
            mRecyclerView.setVisibility(View.VISIBLE);
            mDatas.addAll(data);
        } else {
            tvHintClock.setVisibility(View.VISIBLE);
        ...
        if (mAdapter == null) {
            ...
            mAdapter = new CommonAdapter<ReimndList>(mContext, R.layout.item_clock_remind, mDatas) {
                @Override
                protected void convert(ViewHolder holder, final ReimndList dataBean, int position) {
                    ...
                    holder.setOnClickListener(R.id.tv_delete, new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            rid = dataBean.getId();
                            mPresenter.delRemind(ClockActivity.this);
                        }
                    });
                }
            };
