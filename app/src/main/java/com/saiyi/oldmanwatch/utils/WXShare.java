...
public class WXShare {
    public static final String APP_ID = "wx1627f0da408f4e16";
    ...
    public WXShare share(String text) {
        ...
        Logger.i(TAG, "text shared: " + result);
        return this;
    }
    ...
    private class ResponseReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Logger.d(TAG, "type: " + response.getType());
            Logger.d(TAG, "errCode: " + response.errCode);
            String result;
            if (listener != null) {
