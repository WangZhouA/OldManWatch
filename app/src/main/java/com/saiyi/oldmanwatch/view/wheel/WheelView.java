...
import com.saiyi.oldmanwatch.view.wheel.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    // 条目间距倍数
    static final float lineSpacingMultiplier = 3.0F;
    boolean isLoop;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.dp_18);
