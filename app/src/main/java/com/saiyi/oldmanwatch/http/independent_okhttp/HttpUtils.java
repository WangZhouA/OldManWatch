package com.saiyi.oldmanwatch.http.independent_okhttp;
...
public class HttpUtils {
    ...
    public static String URL1 = Constant.getRoot();//阿里云服务器
    ...
    private static  final  String TGA ="http";
    ...
    public void postAsynHttp(String action, Map<String, String> data, final int HttpType, final HttpRequestCallback requestCallback) {
        ...
        Log.e(TGA,new Gson().toJson(data).toString());

        final Request request = new Request.Builder()
                .url(URL1 + action)
                .post(body)
                .addHeader("token", ((String)SharedPreferencesHelper.get("token", "")))
                .build();
